...
import { LayoutDashboard, Users, Megaphone, HeartPulse, Settings, ScrollText, Image } from "lucide-react";
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-150 ${
                isActive ? "bg-white text-blue-900 shadow-sm" : "hover:bg-blue-800"
              }`}
            >
